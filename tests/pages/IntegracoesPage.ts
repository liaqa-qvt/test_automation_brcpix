...
export class IntegracoesPage {
  ...
  readonly btnNovoAppVazio: Locator;
  ...
  constructor(page: Page) {
    ...
    this.btnNovoAppVazio  = page.locator('button', { hasText: 'Novo app' }).last();
  }

  async goto() {
    await this.page.goto('/painel/integracoes');
  }

  async abrirModalNovoApp() {
    await this.btnNovoApp.click();
  }
}
