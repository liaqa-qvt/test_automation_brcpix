...
/**
 * Page Object — Histórico de Transações
 * URL: https://brcpix.to/painel/transacoes
 */
export class HistoricoPage {
  ...
  // Filtros de status — aria-pressed reais do HTML
  ...
  async goto() {
    await this.page.goto('/painel/transacoes');
  }
}